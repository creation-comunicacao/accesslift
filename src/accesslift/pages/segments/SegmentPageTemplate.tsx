      ...
      {isSegmentHub && (
        <section className="mx-auto max-w-7xl px-4 pb-12 md:px-6">
          <div className="flex flex-wrap gap-3">
            <Button href="/segmentos/industria/" variant="secondary">Soluções para indústria</Button>
            <Button href="/segmentos/construcao-civil/" variant="secondary">Soluções para construção</Button>
            <Button href="/segmentos/supermercados-e-hipermercados/" variant="secondary">Soluções para supermercados</Button>
            <Button href="/segmentos/atacados/" variant="secondary">Soluções para atacados</Button>
