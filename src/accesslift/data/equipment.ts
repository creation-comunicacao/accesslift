...
const equipmentSpecsBySlug: Record<string, Partial<EquipmentSpecs>> = {
  ...
  "genie-gs2632": {
    ...
    capacidade: "227 kg",
    alimentacao: "Elétrica AC E-Drive",
    largura: "0,81 m",
    comprimento: "2,36 m",
...
const equipmentContentBySlug: Record<string, EquipmentContentOverride> = {
  "jlg-2630es": {
    ...
    considerationText: "Pode ser considerada quando o trabalho exige elevação vertical, largura da máquina é um critério relevante, não existe necessidade de alcance articulado e acesso, piso e condições do local são compatíveis.",
  ...
  "jlg-3246es": {
    ...
    faq: [
      ...
      { question: "Qual a capacidade da JLG 3246ES?", answer: "A capacidade máxima registrada na documentação consultada e 320 kg." },
      { question: "Quando escolher uma tesoura em vez de articulada?", answer: "Principalmente quando o acesso ao trabalho e vertical e não ha necessidade de contornar obstáculos com uma lança." },
    ],
    seo: {
    ...
    technicalDataSource: "Documentação JLG familia ES - validar configuração da unidade",
  },
  "jlg-e450aj": {
    ...
    overview: "A JLG E450AJ e uma plataforma articulada elétrica indicada para situacoes em que a elevação vertical, sozinha, não atende as características do trabalho. Sua lança articulada permite combinar altura e alcance horizontal, facilitando o posicionamento quando estruturas, instalações, máquinas ou outros obstáculos impedem que o equipamento fique diretamente abaixo do ponto de execução.",
    ...
    characteristics: ["15,72 m de altura de trabalho", "7,24 m de alcance horizontal", "Capacidade de 230 kg sujeita a validação da unidade", "Alimentacao elétrica", "Jib articulado"],
    ...
    faq: [
      ...
      { question: "A JLG E450AJ e elétrica?", answer: "Sim. A JLG classifica a E450AJ como plataforma articulada elétrica." },
      { question: "Qual a capacidade da plataforma?", answer: "A página trabalha com 230 kg, mas a ficha correspondente a unidade Accesslift deve ser a referencia definitiva antes do go-live." },
    ],
    seo: {
  ...
  "genie-gs1930": {
    ...
    technicalDataSource: "Documentação atual Genie GS-1930 - validar serial para geracoes anteriores",
  },
  "genie-gs2632": {
  ...
  "skyjack-sj3226": {
    ...
    considerationText: "Considere a SJ3226 quando o trabalho exige elevação vertical, faixa próxima de 10 m, largura da máquina é um critério importante e não há necessidade de alcance articulado sobre obstáculos.",
    applications: sharedScissorApplications,
    faq: [
  ...
  "skyjack-sj4732": {
    ...
    considerationText: "Pode ser considerada quando a operação exige aproximadamente 12 m de faixa de trabalho, maior área de plataforma, acesso compativel com sua largura e elevação predominantemente vertical.",
    applications: sharedScissorApplications,
    faq: [
      { question: "Por que o catálogo não tem Skyjack SJ4740?", answer: "A máquina real fotografada foi identificada como Skyjack SJ4732. O cadastro SJ4740 não deve permanecer sem comprovacao do cliente." },
      ...
      { question: "Qual a capacidade da SJ4732?", answer: "A referencia cadastrada e 318 kg, sujeita a confirmação da geracao da unidade." },
    ],
    seo: {
  ...
  "zoomlion-zs1212ac": {
    ...
    considerationText: "Pode ser considerada quando e necessária maior faixa de elevação vertical, a operação comporta aproximadamente 1,15 m de largura, a capacidade e relevante e não ha necessidade de lança articulada.",
