...
export const clientServicePages: ClientPage[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { eyebrow: "Locação", title: "Precisa de suporte durante uma locação?", description: "Se o equipamento estiver em uma locação ativa com a AccessLift, informe os dados da operação e a ocorrência apresentada para facilitar o direcionamento do atendimento.", cta: whatsapp("Solicitar atendimento", "Olá! Tenho uma plataforma AccessLift em locação e preciso de suporte técnico.", "assistencia_whatsapp_rental") },
