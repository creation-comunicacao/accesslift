...
export const clientServicePages: ClientPage[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { eyebrow: "Locação", title: "Precisa de suporte durante uma locação?", description: "Abra um chamado informando os dados da operação e a ocorrência apresentada. A equipe realiza uma triagem remota, inclusive por vídeo quando aplicável, e, quando necessário, um técnico se desloca com as peças e os recursos adequados ao atendimento.", cta: whatsapp("Solicitar atendimento", "Olá! Tenho uma plataforma Accesslift em locação e preciso de suporte técnico.", "assistencia_whatsapp_rental") },
