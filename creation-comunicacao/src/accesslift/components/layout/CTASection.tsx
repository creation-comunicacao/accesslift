  ...
  return (
    <section className="bg-slate-950 text-white">
      <div className="mx-auto grid max-w-7xl gap-6 px-4 py-10 md:grid-cols-[1fr_auto] md:items-center md:px-6">
        <div>
          <h2 className="text-2xl font-black text-white">Precisa de plataforma elevatoria?</h2>
          <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-300">
            Pontos de conversao preparados para orcamento, disponibilidade, especialista e WhatsApp sem depender de dados ficticios.
          </p>
        </div>
